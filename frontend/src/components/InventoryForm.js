...
// ManualAddModal removed in favor of inline QTY input
...
export default function InventoryForm() {
  ...
  // Legacy add-to-cart removed (scan flow handles quantity)
  ...
  // Pricing breakdown for display and computation is handled inside PaymentModal
  ...
  return (
    <>
      ...
      {/* Manual Add removed in favor of QTY input */}
